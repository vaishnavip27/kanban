    ...
    <div className="h-screen relative">
      <div className="flex flex-col items-center">
        <img
          src="/lightbeam.svg"
          alt="bg-image"
          className="absolute inset-0 translate-x-[-50%] translate-y-[-40%] top-1/2 left-1/2"
        />
      </div>
      ...
      <div className="flex flex-col items-center relative justify-center z-10">
        ...
        <div className="flex justify-center mt-20">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 248 204" className="h-5 w-5 text-purple-800">
              <path
                fill="currentColor"
        ...
        <div className="relative mt-28">
          <div className="oval-glow-wrapper">
            <img src="/main-image.png" alt="landing-img" className="max-w-6xl rounded-md relative z-10" />
          </div>
        </div>
      </div>
    </div>
