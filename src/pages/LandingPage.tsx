  ...
  const LandingPage = () => {
    ...
    return <div className="h-screen relative">
      ...
      <div className='flex items-center justify-center flex-col'>
        <h1 className="z-10 bg-gradient-to-br from-[#C0A2FF] to-[#F4EDFF] bg-clip-text text-center font-display text-4xl font-bold tracking-[-0.05em] text-transparent drop-shadow-sm md:text-7xl">
          <div className="flex flex-col items-center">
        ...
        <p className="text-center text-gray-400 text-wrap:balance md:text-xl pt-4 font-medium">
